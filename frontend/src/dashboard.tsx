            ...
            <div className="overlap-8" id = "overlap-8">
              <div className="list-menu-wrapper">
                <div className="list-menu">
                  ...
                  <img className="chevron-right" alt="Chevron right" src="https://cdn.animaapp.com/projects/652caec9cd622539e3544593/releases/652caf6c8e0f2ac1913234dd/img/chevron-right-2.svg"></img>
                </div>
              </div>
