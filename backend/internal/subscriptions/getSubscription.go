...
func (sh*SubscriptionHandler) GetUserSubscriptionCount(response http.ResponseWriter,request *http.Request) {
	...
	if err != nil {
		Response.Send(response,http.StatusInternalServerError,"Error occured getting the user subscripition count",nil)
		return
	}
...
func (sh *SubscriptionHandler) GetAllUserSubscriptions(response http.ResponseWriter,request *http.Request) {
